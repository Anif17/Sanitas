...
<body style="background-image: url(images/skincare_bg.jpg)">
    ...
    //Select Database
    $sql = "SELECT*FROM tb_orddetail WHERE cust_id LIKE '%$search%' ORDER BY prod_id ASC;";
    $result = $mysqli->query($sql)
    ?>

    <h1 align="center" style="padding-top: 7%; padding-bottom: 2%;"><span class="badge badge-info">DELIVERY LIST</span> </h1>
