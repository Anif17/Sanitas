...
<body style="background-image: url(images/skincare_bg.jpg)">
    ...
    <div class="container">
        <div align="center" style="font-size: 40px;"><span class="badge badge-info">ADD PRODUCT</div>
        <div class="content">
            <form action="add_product.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
                        <span class="details">PRODUCT NAME:</span>
                        <input type="text" placeholder="Enter Product ID" name="name" required>
                    </div>
                    <div class="input-box">
                        <span class="details">QUANTITY:</span>
                        <input type="number" name="quantity" placeholder="Enter Product ID" required>
                    </div>
                    <div class="input-box">
                        <span class="details">PRICE:</span>
                        <input type="text" name="price" placeholder="Enter Product ID" required>
                    </div>
                    <div class="input-box">
                        <span class="details">IMAGE SOURCE:</span>
                        <input type="text" name="img" placeholder="Enter Picture URL" required>
                    </div>
                </div>
                <div class="button">
