...
<body style="background-image: url(images/skincare_bg.jpg)">
    ...
    //Select Database
    $sql = "SELECT*FROM tb_orddetail";
    $result = $mysqli->query($sql)
    ?>

    <h1 align="center" style="padding-top: 7%;"><span class="badge badge-info">ORDER LIST</span> </h1>
        ...
        <div align="center" style="padding-top: 2%;">
            ...
            <div class="col-md-8">
                <div class="search">
                    ...
                    <form name="form1" method="post" action="order_search.php">
                        <input type="text" class="form-control" name="txtSearch" placeholder="Search using Order ID..">
