...
<body style="background-image: url(images/skincare_bg.jpg)">
    ...
    <h1 align="center" style="padding-top: 7%;"><span class="badge badge-info">EDIT PRODUCT</span> </h1>
    <div class="container">
        ...
        <div align="center" style="padding-top: 2%;">
            ...
            <div class="col-md-8">
                <div class="search">
                    ...
                    <form name="form1" method="post" action="prod_editSearch.php">
                        <input type="text" class="form-control" name="txtSearch" placeholder="Search Product ID..">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td><a href="edit_product.php?edited=1&id=<?php echo $row['prod_id']; ?>"><img src="icon/edit_icon.ico" alt="edit" width="40px"> <span>Edit</span></a></td>
                            <td><a href="prod_delete.php?deleted=1&id=<?php echo $row['prod_id']; ?>"><img src="icon/delete_icon.ico" alt="delete" width="40px"> <span>Delete</span></a></td>
                        </tr>
