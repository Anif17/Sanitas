...
<body>
    ...
    $id = $_GET['id'];
    $sql = "SELECT * from tb_orddetail where ordDetail_id='$id'";
    $result = $mysqli->query($sql);

    while ($row = $result->fetch_assoc()) {
        $ord_id = $row['ordDetail_id'];
        $cust_id = $row['cust_id'];
        $prod_id = $row['prod_id'];
        $ord_qnty = $row['ordDetail_qnty'];
        $ord_price = $row['ordDetail_price'];
    }
        ...
        <div class="borrow-box">
            ...
            <center>
                <form action="edit.php" method="POST">
                    <h4 align="center" class="heading">EDIT</h4><br>
                    <b>ORDER ID:</b>
                    <input type="text" class="input-field" name="ord_id" value="<?php echo $ord_id; ?>" readonly style="background-color: #D3D3D3;"><br><br>
                    <b>CUSTOMER ID:</b>
                    <input type="text" class="input-field" name="cust_id" value="<?php echo $cust_id; ?>" readonly style="background-color: #D3D3D3;"><br><br>
                    <b>PRODUCT ID:</b>
                    <input type="text" class="input-field" name="prod_id" value="<?php echo $prod_id ?>" readonly style="background-color: #D3D3D3;"><br><br>
                    <b>PRICE :</b>
                    <input type=" text" class="input-field" id="prod_price" name="prod_price" value="<?php echo $ord_price ?>" readonly style="background-color: #D3D3D3;"><br><br>
                    <b>QUANTITY:</b>
                    <input type="text" class="input-field" id="quantity" name="quantity" value="<?php echo $ord_qnty ?>" required style="background-color: #8AFF8A;"><br><br>
                    <b>TOTAL PRICE:</b>
